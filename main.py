...
output_path = "/home/ivlabs/users/karthik/skylark/CV-Assignment-Output/"
...
for file in glob.glob("*.JPG"):
    ...
    graythres = cv2.inRange(grayimg, 230, 255)              #Threshold in grayscale space
...
with open('gcp_locations_output.csv', 'w') as csvFile:
